    ...
    <body class="home page">	
        ...
        <div class="boxed-page">
            ...
            <div class="everything">
                ...
                <div id="map" style="top: 158px;position: relative;">
                    <iframe width="100%" height="350" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.co.in/maps/ms?msa=0&amp;msid=207829258416385582710.0004f7de7f0fd80b2ff05&amp;ie=UTF8&amp;t=m&amp;z=17&amp;output=embed"></iframe>
                </div>
                ...
                <div class="fullwidth-container image" style="background:#80bee3 url(img/preview_images/top-about.jpg); height:80px;">
                    ...
                    <div class="container">
                        <div class="pageTitle">
                            <span class="page_title" style="padding-left:200px; margin-top:-5px;"><a href="index.php">صفحه اصلی</a>&nbsp;>&nbsp;<a href="contactus.php">ارتباط</a></span>
                        </div>
                    </div>
                </div>
                                    ...
                                    <ul class='service-items itemsPerRow-3'>
                                        <li class='service-item no-flicker'>
                                            ...
                                            <p  style="text-align: right; direction: rtl;padding-right: 40px;">شنژن ویسان ارتباطات
                                                ...
                                                <strong>تلفن :</strong> ۰۰۸۶۷۵۵۶۱۵۹۵۸۸۸<br />
                                                <strong>فکس :</strong> ۰۰۸۶۷۵۵۶۱۵۳۶۹۷۰<br />
                                                <strong>پست الکترونیک :</strong> global@vsunmobile.com </p>
                                        </li>
                                        <li class='service-item no-flicker'>
                                        ...
                                        <li class='service-item no-flicker'>
                                            ...
                                            <p style="text-align: right; direction: rtl;">
                                                ...
                                                پلاک ۱۶۴ (۱۵۵-۱۴۲) ، <br>
                                                السبخا، دیره، دبی، امارات متحده عربی<br> 
                                                <br> 
                                                <strong>تلفن :</strong> ۰۰۹۷۱.۴.۲۳۴۰۱۱۲  <br>
                                                <strong>فکس :</strong> ۰۰۹۷۱.۴.۲۳۴۰۱۱۳</p>
                                        </li>
